...
if ( ! defined( 'ABSPATH' ) ) exit; // Exit if accessed directly
	...
	if ( !isset( $genShortcode ) || empty( $genShortcode ) ){
		...
		echo '<div id="zia3_os_example_shortcode">Example Shortcode: <input type="text" spellcheck="false" onclick="this.focus();this.select()" readonly="readonly" style="width:650px;max-width:100%" value="[ zia3-os id=\'' . $id .
		     '\' link_title=\'My Title\' link=\'http://mydomain.com/\' slogan=\'My Slogan\' slogan_link=\'http://mydomain.com/\' link_color=\'255,255,255\' slogan_link_color=\'255,255,255\' ]"/> </div>';
		$exampleGenShortcode = '[ zia3-os id=\'' . $id . '\' link_title=\'My Title\' link=\'http://mydomain.com/\' slogan=\'My Slogan\' slogan_link=\'http://mydomain.com/\' link_color=\'255,255,255\' slogan_link_color=\'255,255,255\' ]';
